...
class Agent(ABC):
    ...
    def run(self, messages: List[Union[Dict, Message]], sessions: Session = None,
        ...
        for rsp in self._run(messages=new_messages, sessions=sessions, **kwargs):
